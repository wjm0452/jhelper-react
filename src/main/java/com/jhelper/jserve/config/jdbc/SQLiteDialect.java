...
import com.jhelper.jserve.config.jdbc.identity.SQLiteIdentityColumnSupport;
...
public class SQLiteDialect extends Dialect {
    ...
    protected boolean supportsMathFunctions() {
        // Math functions have to be enabled through a compile time option:
    ...
    public String translateExtractField(TemporalUnit unit) {
        // All units should be handled in extractPattern so we should never hit this
        // method
